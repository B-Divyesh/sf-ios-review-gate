...
function paidSection() {
  ...
  return `<section class="paid section-rule" aria-labelledby="paid-title"><div><p class="section-no">TEAM POLICY</p><h2 id="paid-title">Keep team rules beside the release</h2><p>The free gate includes every core check and packet export. A Team license adds a local policy builder and queue histories beyond three submissions.</p></div><div class="price-box">${controls}<p id="license-status" class="legal-note" aria-live="polite">${escapeHtml(licenseNotice)}</p><p class="legal-note">Sociobot is the merchant of record. See <a href="/terms" data-link>terms</a>.</p></div></section>`;
}
...
function landing() {
  return shell(`<section class="hero drafting-grid">
    <div class="hero-copy"><p class="eyebrow">Local App Review preflight · rules apple-2026.1</p><h1>Check your iOS release before review</h1>
      ...
      <ul class="facts"><li>Runs on your machine.</li><li>No App Store access.</li><li>Free checks and packets.</li></ul>
    </div>
