...
function landing() {
  ...
  <section id="install" class="install section-rule" aria-labelledby="install-title"><div><p class="section-no">COMMAND / 01</p><h2 id="install-title">Run the gate in your repository</h2><p>Build the single Rust binary, then keep <code>release.yaml</code> beside the app.</p></div><pre><code>cargo install --git https://github.com/B-Divyesh/sf-ios-review-gate
