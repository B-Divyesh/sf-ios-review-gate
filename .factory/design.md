...
- `examples/sample/screenshots/en-US/iphone-69/home.jpg`: a 1320×2868 JPEG made locally on 2026-08-29 from the original release-blueprint artwork above, inset on the same paper color. It is bundled only as the CLI's valid App Store-size sample; no outside asset or service was used.
